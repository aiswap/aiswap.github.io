...
import OKExEvent from '../components/Header/OKExEvent'
...
//   RedirectPathToSwapOnly, RedirectToSwap } from './Swap/redirects'
          ...
          <BodyWrapper>
            <Web3ReactManager>
              <>
                ...
                <Route exact strict path="/expect" component={ComingSoon} />
                ...
                <Route exact strict path="/SFG/:currencyIdA/:currencyIdB" component={Manage} />
