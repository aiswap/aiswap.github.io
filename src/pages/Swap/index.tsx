        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'md'}>
            ...
            <CurrencyInputPanel
              ...
              label={
                independentField === Field.INPUT && !showWrap && trade ? t('exchange.toEstimate') : t('exchange.to')
              }
              showMaxButton={false}
          ...
          <BottomGrouping style={{ padding: '16px 0 0' }}>
            {swapIsUnsupported ? (
              ...
              <ButtonPrimary onClick={toggleWalletModal}>{t('wallet.submitConnect')}</ButtonPrimary>
            ) : showWrap ? (
                ...
                >
                  {approval === ApprovalState.PENDING ? (
                    <AutoRow gap="6px" justify="center">
                      {t('exchange.approving')} <Loader stroke="white" />
                    </AutoRow>
                  ) : approvalSubmitted && approval === ApprovalState.APPROVED ? (
                    t('exchange.approved')
                  ) : (
