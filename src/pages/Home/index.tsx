  ...
  return (
    <PageWrapper gap="lg" justify="center">
            ...
            <AutoColumn gap="md">
              ...
              <RowBetween>
                <TYPE.white fontSize={14}>
                  SFG tokens represent voting shares in Uniswap governance. You can vote on each proposal yourself or
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total SFG supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
