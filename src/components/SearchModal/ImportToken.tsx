    ...
    <Wrapper>
      <PaddedColumn gap="14px" style={{ width: '100%', flex: '1 1' }}>
        <RowBetween>
          ...
          <TYPE.mediumHeader>{t(tokens.length > 1 ? 'tokens.importTokens' : 'tokens.importToken')}</TYPE.mediumHeader>
